...
plt.scatter(treat.get_group('T5')['measDM'], treat.get_group('T5')['simDM'], marker='o', c='blue', s=15, label = 'measVSsim,T5')

plt.scatter(final['rep1']/1000, final['rep2']/1000, marker='x', c='red', s=15, label = 'reps')
...
plt.legend()
#plt.legend((p1, p2), ('measVSsim', 'rep1VSrep2'))
...
plt.scatter(treatN.get_group('T5')['measN'], treatN.get_group('T5')['simN'], marker='o', c='blue', s=15, label = 'measVSsim,T5')
plt.scatter(finalN['rep1N'], finalN['rep2N'], marker='x', c='red', s=15, label = 'reps')
plt.title('Clovergrass', position = (0.9, 0.9), fontweight="bold", fontsize=8)
